...
COMANDO_CRIAR_POSITIVA = 'start /wait ./openCV/opencv_createsamples -img ../objetos/{0}.jpg -bg ../negativas/bg.txt -info ../positivas/positivas{0}/positivas{0}.lst -maxxangle 0.5 -maxyangle 0.5 -maxzangle 0.5 -num {1} -bgcolor 255'
